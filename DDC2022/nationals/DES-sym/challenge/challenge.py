...
if __name__ == "__main__":
    ...
    if int(hashed_message.hex()) == 0:
        # if your command was to cat the flag, then i'll give you the flag!
        ...
        #    print(output)
            ...
            print("Try doing it again but where you print the flag! Send something starting with")
            print("sudo cat flag.txt")
            print("to get the flag!")
