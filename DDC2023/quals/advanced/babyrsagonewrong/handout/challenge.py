...
from secretdata import FLAG, important_information
...
# Some big and important information I'll keep here so i don't forget!
assert isPrime(important_information)
...
p = gen_smooth_prime(1048,15)
q = gen_smooth_prime(1048 - important_information.bit_length(),15,important_information)

n = p*q


m = b"That feeling when you go out of your way to make DDC'22 challenges interesting and original, and the easy path of just making 10 RSA challenges. Then the players complain about there being no RSA challenges!?!! I they don't come to regret that :D"
...
print("Get them back for me before kd realises i broke the challenge, and i'll give you the flag! Please help!")
