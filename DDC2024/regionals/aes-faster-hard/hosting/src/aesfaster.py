...
# DDC note: AES code taken unchanged from https://github.com/boppreh/aes/blob/master/aes.py
# Added custom optimisation on lines 240, 245, 262, 269
...
class AES:
    ...
    def encrypt_block(self, plaintext):
        ...
        for i in range(1, self.n_rounds):
            # Well then quals showed us subtitution ciphers weren't secure. This can't possibly be important.
