...
_sage_const_8 = Integer(8); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_31 = Integer(31)
...
v1 = int.to_bytes(int(fullvalue), byteorder='big', length=int(fullvalue).bit_length() // _sage_const_8  + _sage_const_1 )
print(v1)
v2 = v1.decode()
v3 = v2[_sage_const_2 :]
v4 = int(v3,_sage_const_2 )
v5 = int.to_bytes(v4, byteorder='big', length=_sage_const_31 )
print(v5)
